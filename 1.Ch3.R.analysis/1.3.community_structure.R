...
carib.clust <- simprof(data = carib.com.cl, method.cluster = "ward.D", 
                       method.distance = "czekanowski")
...
carib.dend.plot <- ggplot(carib.dend.data2$segments) + 
  ...
  geom_segment(aes(x=0.8,xend=5.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=5.8,xend=14.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=14.8,xend=21.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=21.8,xend=28.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=28.8,xend=31.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=31.8,xend=34.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=34.8,xend=39.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=39.8,xend=46.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=46.8,xend=50.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=50.8,xend=54.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=54.8,xend=57.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=57.8,xend=71.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=71.8,xend=76.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=76.8,xend=83.2,y=0.1,yend=0.1),size=1)+
  geom_segment(aes(x=83.8,xend=96.2,y=0.1,yend=0.1),size=1)+
  ylim(-3,10)+ 
  coord_flip()
carib.dend.plot
...
cur.dend <- as.dendrogram(cur.clust.veg) #"'dendrogram' with 2 branches and 27 members total"
...
cur.plot <- ggplot(cur.dend.data$segments) + 
  ...
  theme(legend.position = "none",
        ...
        panel.border = element_blank(),
        panel.background = element_blank()) +
  geom_segment(aes(x=0.8,xend=3.2,y=-0.1,yend=-0.1),size=1)+
  geom_segment(aes(x=3.8,xend=8.2,y=-0.1,yend=-0.1),size=1)+
  geom_segment(aes(x=8.8,xend=12.2,y=-0.1,yend=-0.1),size=1)+
  geom_segment(aes(x=12.8,xend=18.2,y=-0.1,yend=-0.1),size=1)+
  geom_segment(aes(x=18.8,xend=22.2,y=-0.1,yend=-0.1),size=1)+
  geom_segment(aes(x=22.8,xend=24.2,y=-0.1,yend=-0.1),size=1)+
  geom_segment(aes(x=24.8,xend=27.2,y=-0.1,yend=-0.1),size=1)+
  ggtitle("Curaçao")+
  ylab("Dissimilarity")+
  ylim(-0.1 ,1)
cur.plot
...
cur.simper <- simper(cur.com[-1], cur.points$cluster) # length is 21 (nb of different pairs among 7 clusters)
cur.simsum <- summary(cur.simper)
# SIMPER but for depth zones and not cluster 
cur.simper.zones <- simper(cur.com[-1], cur.points$cat) 
...
# obtaining coordinates of species
cur.loads <- 
...
cur.pca.plot <- ggplot(cur.points) +
  ...
  geom_segment(data = cur.loads, aes(x = 0, y = 0, xend = PC1*30, yend = PC2*30), 
               lwd = 0.1, 
               arrow = arrow(length = unit(1/2, 'picas'), type = "open")) +
  geom_text_repel(data = cur.loads, aes(x = PC1*30,  y = PC2*30, label = species), 
                  size = 2, segment.color = "grey69") +
  theme_classic() +
...
roa.plot <- ggplot(roa.dend.data$segments, horiz = TRUE) + 
  ...
  theme(legend.position = "none",
        ...
        panel.border = element_blank(),
        panel.background = element_blank()) +
  geom_segment(aes(x=0.8,xend=11.2,y=-0.1,yend=-0.1),size=1)+
  geom_segment(aes(x=11.8,xend=16.2,y=-0.1,yend=-0.1),size=1)+
  geom_segment(aes(x=16.8,xend=21.2,y=-0.1,yend=-0.1),size=1)+
  geom_segment(aes(x=21.8,xend=24.2,y=-0.1,yend=-0.1),size=1)+
  geom_segment(aes(x=24.8,xend=27.2,y=-0.1,yend=-0.1),size=1)+
  ggtitle("Roatan")+
  ylim(-0.15,1)
roa.plot
...
#### 3.4.1. Roatan entire depth range####
roa.com.full <- carib.deep.fishbase %>%
  filter(location == "Roatan") %>%
  select(species, dband, location, abundance, abu.corr) %>%
...
roa.plot.full <- ggplot(roa.dend.data.full$segments, horiz = TRUE) + 
  geom_rect(xmin=26.7,xmax=31.3,ymin=-0.13, ymax=0.95,fill=blue_palette[3])+
  geom_rect(xmin=31.7,xmax=36.3,ymin=-0.13, ymax=0.95,fill=rariP_palette[1])+
  geom_rect(xmin=23.7,xmax=26.3,ymin=-0.13, ymax=0.95,fill=blue_palette[1])+
  geom_rect(xmin=17.7,xmax=20.3,ymin=-0.13, ymax=0.95,fill=blue_palette[1])+
  geom_rect(xmin=20.7,xmax=23.3,ymin=-0.13, ymax=0.95,fill="#DCEEF3")+
  geom_rect(xmin=7.7,xmax=17.3,ymin=-0.13, ymax=0.95,fill=rariP_palette[2])+
  geom_rect(xmin=0.3,xmax=7.3,ymin=-0.13, ymax=0.95,fill="#831EB6")+
  geom_segment(aes(x = x, y = y, xend = xend, yend = yend), color = "black")+
...
bon.plot <- ggplot(bon.dend.data$segments) + 
  ...
  theme(legend.position = "none",
        ...
        panel.border = element_blank(),
        panel.background = element_blank()) +
  geom_segment(aes(x=0.8,xend=3.2,y=-0.18,yend=-0.18),size=1)+
  geom_segment(aes(x=3.8,xend=6.2,y=-0.18,yend=-0.18),size=1)+
  geom_segment(aes(x=6.8,xend=8.2,y=-0.18,yend=-0.18),size=1)+
  geom_segment(aes(x=8.8,xend=11.2,y=-0.18,yend=-0.18),size=1)+
  geom_segment(aes(x=11.8,xend=16.2,y=-0.18,yend=-0.18),size=1)+
  geom_segment(aes(x=16.8,xend=21.2,y=-0.18,yend=-0.18),size=1)+
  ggtitle("Bonaire")+
  ylab("Dissimilarity")+
  ylim(-0.2,1)
bon.plot
...
sta.plot <- ggplot(sta.dend.data$segments, horiz = TRUE) + 
  geom_rect(xmin=12.7,xmax=17.8,ymin=-0.2, ymax=0.95,fill=blue_palette[3])+
  geom_rect(xmin=17.6,xmax=21.3,ymin=-0.2, ymax=0.95,fill=rariP_palette[1])+
  geom_rect(xmin=6.7,xmax=12.3,ymin=-0.2, ymax=0.95,fill=blue_palette[1])+
  geom_rect(xmin=0.7,xmax=6.3,ymin=-0.2, ymax=0.95,fill=rariP_palette[2])+
  geom_segment(aes(x = x, y = y, xend = xend, yend = yend), color = "black")+
  ...
  theme(legend.position = "none",
        ...
        panel.border = element_blank(),
        panel.background = element_blank()) +
  geom_segment(aes(x=0.8,xend=6.2,y=-0.18,yend=-0.18),size=1)+
  geom_segment(aes(x=6.8,xend=12.2,y=-0.18,yend=-0.18),size=1)+
  geom_segment(aes(x=12.8,xend=21.2,y=-0.18,yend=-0.18),size=1)+
  ylab("Dissimilarity")+
  ylim(-0.2,1)+
  ggtitle("St. Eustatius")
sta.plot
...
cluster.plots <- ggarrange(cur.plot, bon.plot+ rremove("ylab"),
                           cur.pca.plot,bon.pca.plot+ rremove("ylab"),
                           sta.plot+ rremove("ylab"),roa.plot+ rremove("ylab"),
                           sta.pca.plot+ rremove("ylab"), roa.pca.plot+ rremove("ylab"),
                           ncol = 2, nrow=4, common.legend=TRUE,legend="bottom")
cluster.plots

ggsave(cluster.plots, file = "plot.dendo.pca.png", width = 9, height = 14)
